...
const ShareKakao = () => {
    ...
    const handleShareKakao = () => {
        ...
        content: {
            ...
            imageUrl:'https://ibb.co/sqGknh7',    // 카카오톡 이미지
            link: {
            mobileWebUrl: 'hhttps://umc-web-week10.netlify.app/', // 배포 링크
            webUrl: 'https://umc-web-week10.netlify.app/',   // 배포 링크
            },
        },
        buttons: [
            {
            ...
            link: {
                mobileWebUrl: 'https://umc-web-week10.netlify.app/', // 배포 링크
                webUrl: 'https://umc-web-week10.netlify.app/',   // 배포 링크
            },
            },
        ],
